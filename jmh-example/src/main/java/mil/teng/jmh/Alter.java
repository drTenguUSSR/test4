...
public class Alter {
    private static final  long TIME_OFFSET = 1719526289928L;
    ...
    public void alter100a() throws InterruptedException {
        long nowA = System.currentTimeMillis() - TIME_OFFSET;
        Thread.sleep(260);
        long nowB = System.currentTimeMillis() - TIME_OFFSET;
